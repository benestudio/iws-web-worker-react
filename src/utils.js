...
//export const workerInstance = new Worker(new URL('worker.js'),{type: 'module'});
...
export const toArrayBuffer = (data) =>
{
    ...
    return enc.encode(data).buffer;//"This is a string converted to a Uint8Array"
}

export const toArrayBuffer2 = async (data) =>
{
    let blob = new Blob([data], { type:  contentTypeCSV});
